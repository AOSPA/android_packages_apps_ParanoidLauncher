...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<ParanoidLauncher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(ParanoidLauncher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        ParanoidLauncher launcher = (ParanoidLauncher) mWeakReference.get();
        if (launcher != null) {
