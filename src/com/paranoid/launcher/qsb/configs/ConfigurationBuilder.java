 ...
 */
package com.paranoid.launcher.configs;
...
import com.paranoid.launcher.BaseQsbView;
...
import com.android.launcher3.icons.BitmapRenderer.Renderer;
...
public class ConfigurationBuilder {
    ...
    public static Intent getSearchIntent(Rect sourceBounds, View gIcon, View micIcon) {
        ...
        return intent.putExtra("source_round_left", true)
                ...
                .setPackage(ParanoidLauncher.SEARCH_PACKAGE).addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_NEW_TASK);
    }
