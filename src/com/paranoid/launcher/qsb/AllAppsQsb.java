...
public class AllAppsQsb extends BaseQsb implements SearchUiManager, OnChangeListener {
    ...
    public void setInsets(Rect insets) {
        setSearchType();
        ((MarginLayoutParams) getLayoutParams()).topMargin = (int) Math.max(-mTranslationY, insets.top - mMarginAdjusting);
        requestLayout();
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        offsetTopAndBottom((int) mTranslationY);
    }
    ...
    public float getScrollRangeDelta(Rect insets) {
        ...
        return (float) (getLayoutParams().height + Math.max(-mTranslationY, insets.top - mMarginAdjusting) + mTranslationY + marginBottom + ((int) (((float) (height - marginBottom)) * 0.45f)));
    }
