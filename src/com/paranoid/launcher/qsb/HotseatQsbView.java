...
public class HotseatQsbView extends BaseQsbView {
    ...
    public int getWidth(int width) {
        CellLayout view = mLauncher.getHotseat();
    ...
    public void noGoogleAppSearch() {
        ...
        if (context.getPackageManager().queryIntentActivities(searchIntent, 0).isEmpty()) {
            try {
                ...
                mLauncher.getCallback().getQsbController().openQsb();
        ...
        mLauncher.getCallback().getQsbController().openQsb().addListener(new AnimatorListenerAdapter() {
            @Override
