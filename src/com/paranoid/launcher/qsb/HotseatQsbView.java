    ...
    public void noGoogleAppSearch() {
        ...
        if (context.getPackageManager().queryIntentActivities(searchIntent, 0).isEmpty()) {
            try {
                ...
                mLauncher.getLauncherCallbacks().getQsbController().openQsb();
        ...
        mLauncher.getLauncherCallbacks().getQsbController().openQsb().addListener(new AnimatorListenerAdapter() {
            @Override
