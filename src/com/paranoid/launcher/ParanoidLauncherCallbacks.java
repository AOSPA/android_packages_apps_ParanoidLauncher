...
public class ParanoidLauncherCallbacks implements LauncherCallbacks,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLauncherClient = new LauncherClient(mLauncher, mOverlayCallbacks, new ClientOptions(((mPrefs.getBoolean(SettingsActivity.MINUS_ONE_KEY, true) ? 1 : 0) | 2 | 4 | 8)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if (SettingsActivity.MINUS_ONE_KEY.equals(key)) {
            ClientOptions clientOptions = new ClientOptions((mPrefs.getBoolean(SettingsActivity.MINUS_ONE_KEY, true) ? 1 : 0) | 2 | 4 | 8);
