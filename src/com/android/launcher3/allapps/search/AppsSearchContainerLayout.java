...
public class AppsSearchContainerLayout extends ExtendedEditText
    ...
    public void setContentVisibility(int visibleElements, PropertySetter setter,
		...
		boolean hasAllAppsHeaderExtra = mAppsView != null
                    && mAppsView.getAppsView().getFloatingHeaderView().hasVisibleContent();
        setter.setViewAlpha(this, (visibleElements & hasAllAppsHeaderExtra ? ALL_APPS_HEADER_EXTRA : ALL_APPS_HEADER) != 0 ? 1 : 0, interpolator);
    }
}
