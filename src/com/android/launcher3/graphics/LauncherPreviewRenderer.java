...
import com.android.launcher3.aospa.icon.AOSPAIconFactory;
...
public class LauncherPreviewRenderer {
    ...
    public LauncherPreviewRenderer(Context context, InvariantDeviceProfile idp, boolean migrated) {
        ...
        AOSPAIconFactory iconFactory =
                new AOSPAIconFactory(context, mIdp.fillResIconDpi, mIdp.iconBitmapSize) { };
