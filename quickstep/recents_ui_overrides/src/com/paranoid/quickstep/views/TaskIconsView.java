                    ...
                    if (mCurrentPage == indexOfChild) {
                        ...
                        if (i4 != 0) {
                            ...
                            if (!FeatureFlags.QUICKSTEP_SPRINGS.get() || !(childAt instanceof TaskIcon)) {
                                i3 = 1;
                                i2 = 0;
                                addAnim(ObjectAnimator.ofFloat(childAt, TRANSLATION_X, (float) i4), 300, Interpolators.FAST_OUT_SLOW_IN, animatorSet);
                            } else {
                                addAnim(new SpringObjectAnimator(childAt, LauncherAnimUtils.VIEW_TRANSLATE_X, 1.0f, 0.5f, 1500.0f, 0.0f, (float) i4), 300, Interpolators.FAST_OUT_SLOW_IN, animatorSet);
                                i3 = 1;
                                i2 = 0;
                            }
                            i9 = i3;
