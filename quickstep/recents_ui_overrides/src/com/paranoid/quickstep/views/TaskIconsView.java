...
public class TaskIconsView extends PagedView implements PagedView.PageCallbacks {
    ...
    public TaskIconsView(Context context, AttributeSet attributeSet) {
        ...
        setLayoutDirection(true ^ Utilities.isRtl(getResources()) ? 1 : 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            if (mTouchDownToStartHome) {
                ...
                if (isDragging()) {
                    AnalyticHelper.get().putAnalytics(AnalyticHelper.Tag.MDM_RECENTS_TAG, AnalyticHelper.Label.MDM_RECENTS_LAUNCH_APP_PATH, "drag_i");
                } else {
                    AnalyticHelper.get().putAnalytics(AnalyticHelper.Tag.MDM_RECENTS_TAG, AnalyticHelper.Label.MDM_RECENTS_LAUNCH_APP_PATH, "swipe_i");
                }
            }
            mTouchDownToStartHome = false;
        } else {
    ...
    public void playTaskIconDismissAnimation(TaskIcon taskIcon) {
        ...
        if (childCount != 0) {
            ...
            getPageScrolls(iArr2, false, new PagedView.ComputePageScrollsLogic() {
                /* class net.oneplus.quickstep.views.$$Lambda$TaskIconsView$RNrhkdK4xUjeBtnPF7ajsbq9Ks */
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                /* class net.oneplus.quickstep.views.TaskIconsView.C33291 */
