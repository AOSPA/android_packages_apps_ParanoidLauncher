...
public class TaskIcon extends ImageView implements PageCallbacks, ViewPool.Reusable {
    ...
    public TaskIcon(Context context, AttributeSet attributeSet, int res) {
        ...
        setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TaskIconsView taskIconsView = getTaskIconsView();
                UiFactory.getRecentsOperationController().onTaskIconsClick(getContext(), 
                        taskIconsView != null ? taskIconsView.indexOfChild(TaskIcon.this) : -1);
    ...
    public void updateTaskIcon() {
        if (mTask != null) {
            cancelPendingLoadTasks();
            mIconLoadRequest = RecentsModel.INSTANCE.get(getContext()).getIconCache().updateIconInBackground(mTask, new Consumer() {
                @Override
    ...
    public void playTaskIconBounceAnimation() {
        ...
        mTaskIconBounceAnimation.setInterpolator(bounce);
